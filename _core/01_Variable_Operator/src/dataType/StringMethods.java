...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.indexOf("ll")); // 일치하는 문자열의 시작인덱스 (string)
		System.out.println(str.indexOf("j", 2)); //지정한 인덱스로부터 찾기
		System.out.println("---------");
		...
		//특정 문자값과 동일여부 [중요: 문자값 비교할 때 반드시 equals()를 사용할 것]
		...
		//문자값으로 변환
		System.out.println(String.valueOf(123467));
		
		//문자값 비교 return =>비교하는 문자값의 아스키 코드 차이 =>int return
		//문자값 비교를 각 자리를 순회하는 방식으로 비교 (최초의 다른 값을 찾아 그차이(아스키코드)값 리턴
